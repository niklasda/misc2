...
namespace Castle.DynamicProxy.Test
{
	...
	public class EasyTypeBuilderTestCase
	{
		...
		public void EmptyMethodReturningVoid()
		{
			...
			EasyMethod emptyMethod = typebuilder.CreateMethod( "DoSomething", null, 
		...
		public void MethodCalc()
		{
            ...
            EasyMethod calcMethod = typebuilder.CreateMethod("Calc", null, ret, arg1, arg2);
		...
		public void FieldsStoreAndLoad()
		{
...

			{
                ...
                EasyMethod m1 = typebuilder.CreateMethod("GetField1", null, ret1);
                ...
                EasyMethod m2 = typebuilder.CreateMethod("GetField2", null, ret2);
		...
		public void MethodInvokingMethod()
		{
            ...
            EasyMethod realCalcMethod = typebuilder.CreateMethod("RealCalc", null, rret, rarg1, rarg2);
		...
		public void NewInstanceExpression()
		{
            ...
            EasyMethod getCache = typebuilder.CreateMethod("GetCache", null, ret);
		...
		public void ArrayRefs()
		{
            ...
            EasyMethod getField1 = typebuilder.CreateMethod("GetField1", null, ret1);
            ...
            EasyMethod getField2 = typebuilder.CreateMethod("GetField2", null, ret2);
		...
		public void CreateCallable()
		{
            ...
            EasyMethod getField1 = typebuilder.CreateMethod("Exec", null, ret1);
		...
		public void CreateMoreComplexCallable()
		{
            ...
            EasyMethod getField1 = typebuilder.CreateMethod("Exec", null, ret1, arg1, arg2, arg3);
			getField1.CodeBuilder.AddStatement( 
				new ReturnStatement( 
					new ConvertExpression( typeof(String), 
						new MethodInvocationExpression( field1, 
		...
		public void EmptyMethodWithPrimitiveTypeRefArg()
		{
            ...
            EasyMethod emptyMethod = typebuilder.CreateMethod("DoSomething", null, ret, refArg);
