...
//            if (that.MethodName.CompareTo(_methodName) != 0)
//            {
//                return false;
//            }
//            if (!that.ReturnType.Equals(_returnType))
//            {
//                return false;
//            }
//            if (that.ParamTypes.Length != _paramTypes.Length)
//            {
//                return false;
//            }
//            for (int idx = 0; idx < that.ParamTypes.Length; ++idx)
//            {
//                if (!that.ParamTypes[idx].Equals(_paramTypes[idx]))
//                {
//                    return false;
//                }
//            }
