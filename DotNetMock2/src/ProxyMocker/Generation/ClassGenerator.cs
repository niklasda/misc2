    ...
    public class ClassGenerator
    {
        ...
        public object Generate(Type type, IMockedCallHandler handler)
        {
            ...
            determineSuperClassAndInterfaces(
                type,
                out superClass, out interfaces, out attrs
                );
        ...
        //        typeName,
        //        typeof(object),
        //        Type.EmptyTypes, TypeAttributes.Public
        //        );
        ...
        private static void determineSuperClassAndInterfaces(Type targetType, out Type superClass, out Type[] interfaces, out TypeAttributes attrs)
        {
            if ((targetType.Attributes & TypeAttributes.Serializable) == TypeAttributes.Serializable)
            {
