...
namespace ProxyMocker
{
    ...
    public class MockClassBuilder
    {
        ...
        /// <param name="attrs">Type attributes that the mock will have</param>
        public MockClassBuilder(
            ModuleBuilder moduleBuilder,
            string mockClassName, Type superClass, Type[] interfaces, TypeAttributes attrs
            )
        {
            _typeBuilder = moduleBuilder.DefineType(
                mockClassName,
                TypeAttributes.Public | attrs,
        ...
        public void ImplementMockedMethod(string methodName, Type returnType, Type[] parameterTypes, MethodInfo mi)
        {
            ...
            if(mi.IsGenericMethod)
            {
               // mi.GetGenericArguments()
                ...
                mi = mi.MakeGenericMethod(mi.GetGenericArguments());
            }
            if (mi != null)
            {
