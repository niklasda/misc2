...
namespace Castle.DynamicProxy.Builder.CodeBuilder
{
	...
	public class EasyEvent : IEasyMember
	{
		...
		public EasyMethod CreateAddOnMethod(MethodAttributes atts, params Type[] parameters)
		{
			...
			{
				m_addOnMethod =
                    new EasyMethod(m_maintype, "add_" + Name, null, atts, new ReturnReferenceExpression(typeof(void)), ArgumentsUtil.ConvertToArgumentReference(parameters));
			}
		...
		public EasyMethod CreateRemoveOnMethod(MethodAttributes atts, params Type[] parameters)
		{
			...
			{
				m_removeOnMethod =
                    new EasyMethod(m_maintype, "remove_" + Name, null, atts, new ReturnReferenceExpression(typeof(void)), ArgumentsUtil.ConvertToArgumentReference(parameters));
			}
