...
namespace Castle.DynamicProxy.Builder.CodeBuilder
{
	...
	public abstract class AbstractEasyType
	{
        ...
        public EasyMethod CreateMethod(String name, Type[] genericTypes, ReturnReferenceExpression returnType, params ArgumentReference[] arguments)
		{
            EasyMethod member = new EasyMethod(this, name, genericTypes, returnType, arguments);
			_methods.Add(member);
			return member;
		}

        public EasyMethod CreateMethod(String name, Type[] genericTypes, ReturnReferenceExpression returnType, MethodAttributes attributes, params ArgumentReference[] arguments)
		{
            EasyMethod member = new EasyMethod(this, name, genericTypes, attributes, returnType, arguments);
			_methods.Add(member);
			return member;
		}

        public EasyMethod CreateMethod(String name, Type[] genericTypes, MethodAttributes attrs, ReturnReferenceExpression returnType, params Type[] args)
		{
            EasyMethod member = new EasyMethod(this, name, genericTypes, attrs, returnType, ArgumentsUtil.ConvertToArgumentReference(args));
			_methods.Add(member);
			return member;
		}
		...
		public virtual Type BuildType()
		{
		    ...
		    // to the method.
		    MethodInfo m = type.GetMethod("GenericMethod1");
