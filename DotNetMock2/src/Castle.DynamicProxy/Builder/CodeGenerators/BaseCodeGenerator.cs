...
namespace Castle.DynamicProxy.Builder.CodeGenerators
{
    ...
    public abstract class BaseCodeGenerator
    {
        ...
        protected virtual void ImplementGetObjectData(Type[] interfaces)
        {
            ...
            EasyMethod getObjectData = MainTypeBuilder.CreateMethod("GetObjectData", null,
        ...
        protected virtual void ImplementCacheInvocationCache()
        {
            ...
            _method2Invocation = MainTypeBuilder.CreateMethod("_Method2Invocation", null, 
 ...
 //               MethodBase mbase = MethodBuilder.GetMethodFromHandle(method.MethodHandle);
                //if(method.IsGenericMethod)
                Type[] tp = method.GetGenericArguments();
   //           tp[0].Name
                
                easyMethod = _typeBuilder.CreateMethod(method.Name, tp,
        ...
        protected virtual MethodInfo GenerateCallbackMethodIfNecessary(MethodInfo method, Reference invocationTarget)
        {
            ...
            EasyMethod easymethod = MainTypeBuilder.CreateMethod(name, method.GetGenericArguments(),
    ...
    internal class CallableField
    {
            ...
            Reference targetArgument, Reference mixinArray)
        {
            ...
            // ndn
            if (_callback.IsGenericMethod)
            {
                _callback = _callback.MakeGenericMethod(typeof(int));
            }
