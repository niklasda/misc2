...
namespace Castle.DynamicProxy.Builder.CodeGenerators
{
	...
	public class ModuleScope
	{
        ...
        private ModuleBuilder CreateModule(bool signStrongName)
        {
            ...
            ModuleBuilder moduleBuilder = _assemblyBuilder.DefineDynamicModule(assemblyName.Name, FILE_NAME, true);
#else
	        _assemblyBuilder =
	            AppDomain.CurrentDomain.DefineDynamicAssembly(
	                assemblyName,
	                AssemblyBuilderAccess.Run);
            ModuleBuilder moduleBuilder = _assemblyBuilder.DefineDynamicModule(assemblyName.Name, true);
#endif
