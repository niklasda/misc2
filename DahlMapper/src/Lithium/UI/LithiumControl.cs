...
namespace Netron.Lithium
{
    ...
    //        graphAbstract = new GraphAbstract();
      //      graphAbstract.Shapes.OnShapeAdded += new ShapeData(OnShapeAdded);
       ...
       //     selectedEntity = AddRoot(defaultRootName);
...
//        }
        ...
        protected override void OnPaintBackground(PaintEventArgs e)
        {
            ...
            g.DrawString("Lithium Tree Layout Control [version " + version + "]", Font, Brushes.SlateGray, new Point(20, 10));
        ...
        public void NewDiagram(string rootName)
        {
          ...
          //  this.AddRoot(rootName);
            ...
            selectedEntity = AddRoot(rootName);
            selectedEntity.IsSelected = true;
 ...
 //           bool isParent = containerNode.childNodes.Count > 0 ? true : false;
   ...
   //     {
     ...
     //   }
        ...
        /// <summary>
        /// Inserts a parent node to the currently selected one
        /// </summary>
        public void InsertParent()
        {
            ...
            if (sh != null)
            {
                ShapeBase parent = sh.ParentNode;
                if (sh.parentNode != null)
                {
                    ShapeBase parentChild = parent.AddChild("New parent");
                    ShapeBase orginal = parentChild.AddChild(sh.Text);

                    selectedEntity = orginal;
                    orginal.IsSelected = true;
                    
                    parent.ChildNodes.Remove(sh);
        ...
        /// <summary>
        /// Adds a node to the currently selected one's parent
        /// </summary>
        public void AddSibling()
        {
            ...
            if (sh != null)
            {
                ...
                if (sh.parentNode != null)
                {
                    ShapeBase parentChild = parent.AddChild("New sibling");
                    //   parentChild.AddChild(sh.Text);
                    //   parent.ChildNodes.Remove(sh);
