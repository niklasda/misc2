...
namespace PasswordManager
{
	...
	/// </summary>
	public class FormPasswordManager : System.Windows.Forms.Form
	{
		#region gui
		...
		/// </summary>
		public FormPasswordManager(string p_sSettingsFileName)
		{
			//
		...
		private void updateStatusBar()
		{
			...
			{
				sbpCount.Text = dicPasswords.Count.ToString() +" passwords";
		...
		{
			FormPasswordProperties oForm = new FormPasswordProperties();
